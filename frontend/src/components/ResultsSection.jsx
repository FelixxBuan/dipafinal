            ...
            <div className="flex flex-col items-center mb-12 mt-12 text-center space-y-6 w-full px-4">
              ...
              <div className="bg-yellow-500/20 backdrop-blur-md border border-yellow-400/40 rounded-xl px-8 py-4 max-w-4xl w-full text-center">
                <p className="text-sm sm:text-base text-white/90">
                  ⚠️ Disclaimer: The results shown are recommendations based on
                  your inputs and available school data. They are for reference
                  only and should not replace official guidance from the
                  institutions.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          {results.map((item, index) => {
            ...
            if (
              ...
              distanceText = `Approx. ${distance.toFixed(
                2
              )} km from your detected/pinned location to ${item.school}`;
            }
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5">
                      ...
                      <div className="flex items-center gap-3 bg-white/10 p-3 rounded-2xl shadow-md backdrop-blur-md border border-white/20">
                        ...
                        <div>
                          ...
                          <p className="font-semibold">
                            {item.admission_requirements || "N/A"}
                          </p>
                        </div>
                      </div>
                        ...
                        <div>
                          ...
                          <p className="font-semibold">
                            {item.tuition_per_semester ||
                              "Free under gov’t-supported program"}
                          </p>
                        </div>
                      </div>
                    ...
                    {mapsQuery && (
                      <div className="mt-6 space-y-4">
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          {distanceText ? (
                            <div className="flex items-center gap-3 bg-white/10 p-3 rounded-2xl shadow-md backdrop-blur-md border border-white/20">
                              <Ruler className="w-8 h-8 text-blue-300" />{" "}
                              {/* enlarged icon */}
                              <div>
                                <p className="text-xs uppercase tracking-wide opacity-70">
                                  Distance
                            ...
                            <div className="text-sm italic text-white">
                              📍 Distance not available. Enable or pin your
                              location to see distance.
                            </div>
                          )}
                        </div>
