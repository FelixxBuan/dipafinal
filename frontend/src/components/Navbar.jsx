...
function Navbar() {
  ...
  return (
    <div className="w-full flex justify-center absolute top-4 xs:top-5 sm:top-6 left-0 z-50">
      <nav
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span
                    className="font-semibold text-white text-xs xs:text-sm sm:text-base md:text-lg"
                    style={{ fontFamily: "Poppins, sans-serif" }}
                  >
                    {text}
                  </span>
